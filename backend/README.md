...
## Project Structure
    ...
    ├── ideapros_spotcha_36058  # Django project configurations
...
1. Clone this repo and `cd ideapros_spotcha_36058`
...
2. Clone this repo and `cd ideapros_spotcha_36058`
